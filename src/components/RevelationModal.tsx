							...
							>
								...
								<div className="flex-1 flex gap-2.5 justify-start items-center">
									...
									<div className="flex items-baseline gap-2.5">
										...
										{isGrandWinner && (
											<span className="font-mono font-bold text-[11px] uppercase tracking-widest text-indigo-500 ">Winner</span>
										)}
									</div>
								</div>
								...
								<div className="w-24 flex gap-1 justify-end items-center">
									...
									<span
										className={`font-mono text-lg font-black italic leading-none ${isGrandWinner ? "text-indigo-500" : "text-slate-900"}`}
									>
										{seer.essence}
									</span>
								</div>
								...
								{(isGrandWinner || isRoundWinner) && (
									<div className="absolute -left-1 top-1/2 -translate-y-1/2 w-1.5 h-2/3 bg-indigo-500 rounded-full" />
								)}
							</div>
						);
					})}
