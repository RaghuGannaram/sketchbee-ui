					...
					{prophecies.map((word, index) => {
						return (
							<button
                                ...
                                `}
							>
								<span className={"absolute top-4 left-4 font-mono text-[9px] text-slate-400 transition-colors group-hover:text-slate-900"}>
									0{index + 1}
								</span>

								<span className={"font-mono text-xl text-slate-700 uppercase tracking-widest group-hover:text-slate-900 transition-colors"}>
									{word}
								</span>

								<div
									className={
										"absolute bottom-6 transition-all duration-300 opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0"
									}
								>
									<span className={"font-mono font-bold text-[8px] uppercase tracking-[0.2em] text-slate-400 transition-colors"}>
										Lock this word
									</span>
								</div>
							</button>
